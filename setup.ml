...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9ae644be46b6c550ab837087bfb741cb) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         [
            "-use-ocamlfind";
            "-j 0 -use-menhir -menhir 'menhir --dump --explain --infer'"
         ];
     test =
       [
          ("all",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./run_tests.native", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/rewrite";
          bugreports = None;
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Jupyter notebook";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "rewrite";
                           FindlibPackage ("linenoise", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ipython_server.ml"});
               Executable
                 ({
                     cs_name = "run_tests";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "i\187\162\197\154S\0187\135\235be\215\219\143\177";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
